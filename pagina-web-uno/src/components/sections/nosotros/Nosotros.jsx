    ...
    return (
        <div className='container-nosotros'>
            ...
            <div className='container-nosotros-text'>
                <h1>NOSOTROS</h1>
                <p> ¡Dedicados al cuidado integral de adultos por más de 10 años! Nuestra SPA se especializa en brindar servicios de salud, belleza y bienestar. Con una trayectoria ininterrumpida, hemos atendido con dedicación a más de 20,000 pacientes. En nuestra travesía, hemos acumulado experiencia invaluable, consolidando nuestro compromiso desde la Dirección Médica para asegurar servicios de calidad y excelencia. 
